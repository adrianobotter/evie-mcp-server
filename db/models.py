...
Migrated from src/evie/models.py with new PRD fields added for forward compatibility.
"""
...
class EvidenceObject(BaseModel):
    ...
    # PRD v2.0 fields (forward compatibility — populated in Phase 2+)
    evidence_badge: Optional[str] = None  # green / amber / red
    audience_routing: Optional[list[str]] = None  # ["hcp", "payer", "patient", "msl"]
    evidence_hierarchy_level: Optional[str] = None  # L1 / L2 / L3
    dark_data_flag: Optional[bool] = None
    fair_balance_text: Optional[str] = None
    cross_trial_comparison_policy: Optional[str] = None
    render_requirements: Optional[dict] = None
